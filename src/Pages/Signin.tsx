  ...
  return (
    <div className="h-[100vh] w-[100vw] px-3 flex bg-blue-50 justify-center items-center">
      <div className="text-center px-10 py-4 bg-blue-50 rounded-xl ">
        <h1 className="text-[3rem] font-bold">Signin</h1>
        <p className="text-md  text-gray-600 font-medium">
          Connect with us using your google account
        </p>
        {/* <div className="text-start mt-5">
          <form onSubmit={handleSubmit} className="">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-blue-700 text-white font-semibold text-lg rounded-xl"
            >
